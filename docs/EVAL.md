...
|---|---|---|
| **NDCG@10** | **0.5386** | Higher is better (CI gate: no drop > 0.02) |
| **NDCG@50** | **0.8075** | Higher is better |
| **Precision@10** | **0.7000** | Higher is better |
| **MRR** | **0.2500** | Higher is better |
| **Kendall Tau** | **0.0132** | Higher is better |
| **Expected Calibration Error (ECE)** | **0.2802** | Lower is better |
